# python3 bin_to_pcd.py --src_path=/home/artiv/lidar_example/data_object_velodyne/training/velodyne --dest_path=/home/artiv/lidar_example/data_object_velodyne/training/velodyne_pcd
import argparse
...
'''bin file to pcd file'''

def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--src_path', required = True)      # /home/artiv/lidar_example/data_object_velodyne/training/velodyne
    parser.add_argument('--dest_path', required = True)     # /home/artiv/lidar_example/data_object_velodyne/training/velodyne_pcd
